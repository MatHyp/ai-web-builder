    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="mt-12 space-y-4 sm:mt-16 sm:space-y-0 sm:grid sm:grid-cols-2 sm:gap-6 lg:max-w-4xl lg:mx-auto xl:max-w-none xl:mx-0 xl:grid-cols-3">
            @if(isset($data['plans']) && is_array($data['plans']))
                ...
                <div class="border border-gray-200 rounded-lg shadow-sm divide-y divide-gray-200 bg-white flex flex-col hover:border-primary-500 transition-colors duration-300">
                    ...
                    <div class="p-6 bg-gray-50 rounded-b-lg mt-auto">
                        <a href="#contact" class="block w-full py-3 px-6 border border-transparent rounded-md shadow bg-primary-600 text-base font-medium text-white hover:bg-primary-700 text-center transition-colors">
                            Wybierz ten plan
                        </a>
                    </div>
                </div>
